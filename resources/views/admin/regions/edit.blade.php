                      ...
                      <div class="tab-content trip-tab-form">
                        ...
                        <div class="tab-pane active" id="kt_tabs_1_1" role="tabpanel">
                          <div class="form-group">
                              ...
                              <div class="row">
                                <div class="col-lg-7">
                                  <div class="mb-3">
                                      <img id="cropper-image" class="crop-img-div" src="{{ $region->image_url }}">
                                  </div>
                          ...
                          <div class="form-group">
                              <label>Title</label>
                              <input type="text" value="{{ $region->name }}" name="name" class="form-control" aria-describedby="emailHelp" placeholder="Title" required>
                          </div>
                          <div class="form-group">
                              <div class="form-group">
                                <label >Country</label>
                        ...
                        <div class="tab-pane" data-index="2" id="kt_tabs_1_2" role="tabpanel">
                          <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                              <textarea name="seo[meta_title]" class="form-control form-control-sm" id="" cols="30" rows="2">{{ $region->seo->meta_title ?? '' }}</textarea>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                              <textarea name="seo[meta_keywords]" class="form-control form-control-sm" id="" cols="30" rows="2">{{ $region->seo->meta_keywords ?? '' }}</textarea>
                              {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                            </div>
                          </div>
                          <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" id="input-trip-name" value="{{  $region->seo->canonical_url ?? '' }}" class="form-control form-control-sm" name="seo[canonical_url]">
                              {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                            </div>
                          </div>
                          <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                              <textarea name="seo[meta_description]" class="form-control form-control-sm" id="" cols="30" rows="2">{{ $region->seo->meta_description ?? '' }}</textarea>
                              {{-- <span class="form-text text-muted">Please enter your full name</span> --}}
                            </div>
                          </div>
                          <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                              <div>
                                <p id="social_image_name">{{ $region->seo->social_image ?? '' }}</p>
                              </div>
                              <div>
...
$(function() {
  ...
  function handleRegionForm(form) {
    ...
    $.ajax({
        url: "{{ route('admin.regions.update') }}",
        type: 'POST',
        data: formData,
        dataType: 'json',
        processData: false,
