...
@section('content')
    ...
    @if (isset($blog->similar_blogs) && $blog->similar_blogs->isNotEmpty())
        <section class="py-10 mb-5 news bg-gray">
            <div class="container">
                <h2 class="relative pt-10 pb-10 pr-10 text-3xl font-bold text-gray-600 uppercase font-display">You might be interested in</h2>
