...
@section('content')
    ...
    <section>
        <div class="py-10 bg-light">
            {{-- Activities --}}
            <div class="grid max-w-5xl grid-cols-2 gap-4 py-20 mx-auto lg:grid-cols-4 lg:justify-center">
    ...
    <section>
        ...
        <div class="relative py-20">
            <div class="container grid gap-20 lg:grid-cols-2">
                ...
                @else
                    <div class><img src="{{ asset('assets/front/img/nepal.webp') }}"></div>
                @endif
            </div>
        </div>{{-- Travel Guide --}}
    </section>
    ...
    <section>
        <div class="py-10 border-t border-gray-400">
            <div class="container">
