<a href="{{ route('front.activities.show', $activity->slug) }}" class="@if ($loop->first) col-span-2 row-span-2 @endif flex items-center gap-4 relative overflow-hidden">
    <img src="{{ $activity->imageUrl }}" alt="{{ $activity->name }}" class="block object-cover w-full h-full transition duration-700 scale-105 aspect-square hover:scale-100" loading="lazy">
